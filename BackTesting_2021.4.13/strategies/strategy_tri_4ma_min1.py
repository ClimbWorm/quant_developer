...
hyper_parameter = [{"min1_ma_periods": min1_ma_periods,  # 一分钟线 4个周期
                   ...
                   for min1_ma_periods in [(34, 89, 233, 610), ]  # min1_ma_comb
                   for min1_ma_type in ['ema', ]
                   for min1_bolling_len in bolling_line_list[:-1]
                   for min1_bolling_dev in bolling_dev[1:]
                   for min1_bolling_ma_type in ['sma', ]
                   for min5_bolling_len in bolling_line_list[:-1]
                   for min5_tp_bolling_dev in bolling_dev[1:]
                   for min5_sl_bolling_dev in bolling_dev[1:]
