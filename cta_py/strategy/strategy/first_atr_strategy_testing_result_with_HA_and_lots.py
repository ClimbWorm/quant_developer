...
def ATRRegression_HA_donot_limit_open(df_long, zzg_num,CaS):
    '''
    程序还是按照15min的框架来写吧
    df_long为15min的数据
...
def save_result(table_15_min, zzg_num, CaS):
    ...
    fig.savefig(
        '../code_generated_csv/first_atr_strategy_testing_result_with_HA_and_lots/pic_{}.png'.format(zzg_num))
    folder = "F:\\pythonHistoricalTesting\\pythonHistoricalTesting\\code_generated_csv\\first_atr_strategy_testing_result_with_HA_and_lots"
