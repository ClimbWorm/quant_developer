...
def ATRRegression_HA_donot_limit_open(df_long, zzg_num,
    ...
    for i in range(1, len(df_long)):
        ...
        if distance > 5:
            ...
            # def flatten_orders(CurrentTime, OpenedOrders, i):  # 平仓
...
def save_result(table_15_min, zzg_num, CaS,
    ...
    fig.savefig(
        '../code_generated_csv/900_zzg_num_and_stoploss_fixed/pic_{}_{}.png'.format(zzg_num,loss_mode_4_percent_fixed))#
    folder = "F:\\pythonHistoricalTesting\\pythonHistoricalTesting\\code_generated_csv\\900_zzg_num_and_stoploss_fixed"
...
if __name__ == '__main__':
    ...
    # fixed_percent_list = np.arange(0.0001, 0.0052, 0.0002)  # np.arange(0.0001, 0.0101, 0.005)
    fixed_percent_list = np.arange(0.0052, 0.0102, 0.0002)
